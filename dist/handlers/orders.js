...
export const addOrderItem = async (req, res) => {
    try {
        ...
        const base_price_cents = variation?.price_delta_cents ??
...
----------------------------------------------------- */
export const recalcOrderTotal = async (id_order) => {
...
export const removeOrderItemIngredient = async (req, res) => {
    try {
...
export const recalcOrderItemTotals = async (id_order_item) => {
...
export const customizeOrderItem = async (req, res) => {
    try {
        ...
        for (const ing of ingredients) {
            rows.push({
                ...
                is_removed: ing.ingredient_role === "base" && !ing.is_default_selected
                    ? true
                    : false,
                // precio extra convertido a cents
                additional_price_cents: ing.is_default_selected && ing.ingredient_role === "extra"
